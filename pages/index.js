...
export default function Home() {
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <Navbar />
      <main className="pt-14 min-h-[450px] flex">
        <div className="w-full md:w-2/3 md:h-[500px] mx-4 relative overflow-hidden rounded-2xl">
          ...
          />
          <div className="p-4 sm:p-12 w-full lg:w-3/4 absolute top-0 ">
            <h1 className="text-2xl font-semibold sm:text-6xl leading-normal">
              Hey, I'm Eliane.
            </h1>
            <h2 className="uppercase text-sm sm:text-base tracking-widest mb-2">
              Frontend developer
            </h2>
            <p className="mb-0 sm:mb-40 md:mb-24">
            ...
            <button className="px-3 py-2 mr-2 text-xs sm:text-base sm:py-3 sm:px-6 text-white bg-black rounded-full">
              Contact me
            </button>
            <button className="w-12 h-12 mr-2 bg-neutral-50 rounded-full">
